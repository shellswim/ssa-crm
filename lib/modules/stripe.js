...
exports.retrieveQuote = function(options) {
  ...
  return stripe.quotes.retrieve(quote,__extra);
};
...
exports.acceptQuote = function(options) {
  ...
  delete options.quote;
  return stripe.quotes.accept(quote,__extra);
};
...
exports.cancelQuote = function(options) {
  ...
  delete options.quote;
  return stripe.quotes.cancel(quote,__extra);
};
...
exports.listQuoteComputedUpfrontLineItems = function(options) {
  ...
  return stripe.quotes.listComputedUpfrontLineItems(options,__extra);
};
...
exports.listQuoteLineItems = function(options) {
  ...
  return stripe.quotes.listLineItems(options,__extra);
};
...
exports.retrieveQuotePdf = function(options) {
  ...
  delete options.quote;
  return stripe.quotes.retrievePdf(quote,__extra);
};
...
exports.retrieveTaxCode = function(options) {
  ...
  delete options.id;
  return stripe.taxCodes.retrieve(id,__extra);
};
